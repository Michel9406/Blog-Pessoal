...
public class UsuarioControllerTest {
	...
	public void deveAtualizarUmUsuario() {
		...
		Optional<Usuario> usuarioCadastrado = usuarioService
				.cadastrarUsuario(new Usuario(0L, "Juliana Andrews", "juliana_andrews@email.com.br", "julia123", "-"));
	...
	public void deveMostrarTodosUsuarios() {
		...
		usuarioService
				.cadastrarUsuario(new Usuario(0L, "Ricardo Marques", "ricardo_marqus@email.com.br", "ricardo123", "-"));
